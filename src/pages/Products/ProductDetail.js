...
export const ProductDetail = () => {
  ...
  const trimmedStringNumber = params.id;
  // const convertedNumber = Number(trimmedStringNumber);
  // console.log(convertedNumber);
  const [productDetail, setProductDetail] = useState({});
  useEffect(() => {
    const searchData = async () => {
      const response = await fetch(
        `https://dummyjson.com/products/${trimmedStringNumber}`
      );
  ...
  //   `https://dummyjson.com/products/${convertedNumber}`
  // );
  // const images = productDetail.images[0];
      ...
      <div className="container-fluid py-5">
        <div className="row px-xl-5">
          ...
          <div className="col-lg-7 pb-5">
            <h3 className="font-weight-semi-bold">{productDetail.title}</h3>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <span className="d-block">Brand - {productDetail.brand}</span>
          </div>
        </div>
      </div>
    </>
